...
DtFecha fechaSistema() {
    ...
    DtFecha fecha = new DtFecha(dia, mes, anio, horas, minutos);
    return fecha;
}

Relojito::Relojito() 
{
    DtFecha fechaSistema = fechaSistema();
...
{
    DtFecha fecha = new DtFecha(this->dia, this->mes, this->anio, this->horas, this->minutos);
    return fecha;
}
